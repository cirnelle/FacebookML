...
path_to_store_features_by_probability_file = '../output/feature_importance/nb/maas/nb_feat_by_prob.csv'
path_to_store_feature_selection_boolean_file = '../output/feature_importance/nb/maas/nb_fs_boolean.csv'
path_to_store_list_of_feature_file = '../output/feature_importance/nb/maas/nb_feature_names.txt'
path_to_store_coefficient_file = '../output/feature_importance/nb/maas/nb_coef.txt'
path_to_store_feature_log_prob_for_class_0 = '../output/feature_importance/nb/maas/nb_feature_prob_0.csv' #Empirical log probability of features given a class
path_to_store_feature_log_prob_for_class_1 = '../output/feature_importance/nb/maas/nb_feature_prob_1.csv'
path_to_store_feat_imp_for_normalisation = '../output/featimp_normalisation/nb/maas/maas.csv'
path_to_store_important_features_by_class_file = '../output/feature_importance/nb/maas/nb_feat_by_class_combined.csv'
