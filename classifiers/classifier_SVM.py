...
class SVM():
    ...
    def train_classifier(self):
        ...
        clf = SVC(C=1.0, cache_size=200, class_weight=None, coef0=0.0, degree=3, kernel='rbf', gamma=0.1,
                  ...
                  tol=0.001, verbose=False).fit(X_tfidf, y_train)
    ...
    def use_pipeline(self):
        ...
        parameters = {
            ...
            'clf__gamma': ('auto', 0.1, 0.001, 0.0001),
        }
...
path_to_labelled_file = '../output/features/space/likecorr/labelled_combined.csv'
...
if __name__ == '__main__':
    ...
    clf, count_vect = svm.train_classifier()


    ###################
    # run SVM Classifier and use feature selection
    ###################

    #clf, count_vect = svm.train_classifier_use_feature_selection()
    ...
    #clf, count_vect = svm.use_pipeline()

    ###################
    # use pipeline and use feature selection
    ###################

    #clf, count_vect = svm.use_pipeline_with_fs()
