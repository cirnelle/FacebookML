...
class DecisionTree():
    ...
    def train_classifier(self):
        ...
        print ("Fitting data ...")
        clf = DecisionTreeClassifier().fit(X_tfidf, y_train)
    ...
    def train_classifier_use_feature_selection(self):
        ...
        clf = DecisionTreeClassifier().fit(X_features, y_train)
    ...
    def plot_feature_selection(self):
        ...
        clf = Pipeline([('anova', transform), ('clf', DecisionTreeClassifier())])
...
path_to_store_vocabulary_file = '../output/feature_importance/decisiontree/space/decisiontree_vocab.txt'
path_to_store_feature_selection_boolean_file = '../output/feature_importance/decisiontree/space/decisiontree_fs_boolean.csv'
path_to_store_complete_feature_importance_file = '../output/feature_importance/decisiontree/space/decisiontree_feat_imp_all.txt'
path_to_store_top_important_features_file = '../output/feature_importance/decisiontree/space/decisiontree_feature_importance.csv'
path_to_store_important_features_by_class_file = '../output/feature_importance/decisiontree/space/decisiontree_feat_byClass_combined.csv'

path_to_store_feat_imp_for_normalisation = '../output/featimp_normalisation/decisiontree/space.csv'
...
if __name__ == '__main__':
    ...
    docs_train,docs_test,y_train,y_test = dt.train_test_split()
    #docs_train,docs_test,y_train,y_test = dt.stratified_shufflesplit()
    #docs_train,docs_test,y_train,y_test = dt.stratified_kfolds()
    ...
    #clf, count_vect = dt.train_classifier()
    ...
    #clf, count_vect = dt.train_classifier_use_feature_selection()
    ...
    #clf, count_vect = dt.use_pipeline()

    ###################
    # use pipeline and use feature selection
    ###################

    clf, count_vect = dt.use_pipeline_with_fs()
    ...
    dt.get_important_features(clf,count_vect)
