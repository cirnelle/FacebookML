...
path_to_nb_file = '../output/featimp_normalisation/nb/nonprofit.csv'
path_to_sgd_file = '../output/featimp_normalisation/sgd/nonprofit.csv'
path_to_extratree_file = '../output/featimp_normalisation/extratree/nonprofit.csv'
...
path_to_feature_score_file_cf = '../output/featimp_normalisation/nb/nonprofit.csv'
path_to_store_normalised_feature_file = '../output/featimp_normalisation/nb/others/nonprofit_normalised.csv'

#------------------

# change the FIELD for the following
path_to_normalised_nb_file = '../output/featimp_normalisation/nb/others/nonprofit_normalised.csv'
path_to_normalised_sgd_file = '../output/featimp_normalisation/sgd/others/nonprofit_normalised.csv'
path_to_normalised_extratree_file = '../output/featimp_normalisation/extratree/others/nonprofit_normalised.csv'
path_to_store_feature_mean_score = '../output/spss/others/nonprofit_feature_mean.csv'
