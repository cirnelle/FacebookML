...
path_to_liwc_result_file = '../output/liwc/nasa/liwc_nasa_real.txt'
...
path_to_store_labelled_urlhashtagtype_file = '../output/features/nasa/real/labelled_urlhashtagtype.csv'
