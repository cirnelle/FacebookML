...
path_to_labelled_raw_file = '../output/engrate/likecorr/others/labelled_politics_raw_likecorr.csv'
path_to_labelled_preprocessed_file = '../output/engrate/likecorr/others/labelled_politics_likecorr.csv'

path_to_store_psychometric_feature_file = '../output/features/politics/likecorr/psychometrics.txt'
path_to_store_grammar_feature_file = '../output/features/politics/likecorr/grammar.txt'
path_to_store_combined_feature_file = '../output/features/politics/likecorr/combined.txt'
path_to_store_combined_feature_all_file = '../output/features/politics/likecorr/combined_all.txt' #includes word features

path_to_store_labelled_psychometric_file = '../output/features/politics/likecorr/labelled_psychometrics.csv'
path_to_store_labelled_grammar_file = '../output/features/politics/likecorr/labelled_grammar.csv'
path_to_store_labelled_urlhashtagtype_file = '../output/features/politics/likecorr/labelled_urlhashtagtype.csv'
path_to_store_labelled_combined_features_file = '../output/features/politics/likecorr/labelled_combined.csv'
path_to_store_labelled_combined_features_all_file = '../output/features/politics/likecorr/labelled_combined_all.csv'
...
analytic_top = 98.0
analytic_bottom = 76.0
clout_top = 92.0
clout_bottom = 50.0
authentic_top = 58.0
authentic_bottom = 2.82
tone_top = 98.0
tone_bottom = 25.0
sixltr_top = 27.0
sixltr_bottom = 15.0
