...
path_to_raw_fb_data_file = '../fb_data/posts/raw_fb_post_20160226_follcorr.csv'
#path_to_raw_fb_data_file = 'test.csv'
path_to_store_processed_fb_data_file = '../fb_data/posts/preprocessed_fb_posts_20160226_follcorr.csv'
